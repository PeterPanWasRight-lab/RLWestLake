###########################################################################
## Makefile generated for component 'DPGandLQRsimOnlyIdentH'. 
## 
## Makefile     : DPGandLQRsimOnlyIdentH.mk
## Generated on : Tue Mar 10 14:17:25 2026
## Final product: ./DPGandLQRsimOnlyIdentH.exe
...
PRODUCT_NAME              = DPGandLQRsimOnlyIdentH
MAKEFILE                  = DPGandLQRsimOnlyIdentH.mk
MATLAB_ROOT               = C:/APPS/MATLAB/setup
MATLAB_BIN                = C:/APPS/MATLAB/setup/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/RL/RLWestLake/matlab_version/ch10/DPG/simulinkDPGtest
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = DPGandLQRsimOnlyIdentH_comp.rsp
CMD_FILE                  = DPGandLQRsimOnlyIdentH.rsp
...
PRODUCT = ./DPGandLQRsimOnlyIdentH.exe
...
DEFINES_STANDARD = -DMODEL=DPGandLQRsimOnlyIdentH -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/DPGandLQRsimOnlyIdentH.c $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/DPGandLQRsimOnlyIdentH_capi.c $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/DPGandLQRsimOnlyIdentH_data.c $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/DPGandLQRsimOnlyIdentH_tgtconn.c $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/raccel/main.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = DPGandLQRsimOnlyIdentH.obj DPGandLQRsimOnlyIdentH_capi.obj DPGandLQRsimOnlyIdentH_data.obj DPGandLQRsimOnlyIdentH_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj main.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
DPGandLQRsimOnlyIdentH.obj : $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/DPGandLQRsimOnlyIdentH.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DPGandLQRsimOnlyIdentH_capi.obj : $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/DPGandLQRsimOnlyIdentH_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DPGandLQRsimOnlyIdentH_data.obj : $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/DPGandLQRsimOnlyIdentH_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DPGandLQRsimOnlyIdentH_tgtconn.obj : $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/DPGandLQRsimOnlyIdentH_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/DPGandLQRsimOnlyIdentH/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
